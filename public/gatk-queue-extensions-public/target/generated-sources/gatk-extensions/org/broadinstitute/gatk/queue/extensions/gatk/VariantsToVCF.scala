...
/** Input variant file */
@Input(fullName="variant", shortName="V", doc="Input variant file", required=true, exclusiveOf="", validation="")
var variant: File = _
...
@Argument(fullName="sample", shortName="sample", doc="The sample name represented by the variant rod", required=false, exclusiveOf="", validation="")
var sample: String = _
