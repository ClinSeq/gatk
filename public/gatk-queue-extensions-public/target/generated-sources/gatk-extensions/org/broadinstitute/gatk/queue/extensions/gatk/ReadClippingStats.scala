...
class ReadClippingStats extends org.broadinstitute.gatk.queue.extensions.gatk.CommandLineGATK with ScatterGatherableFunction {
analysisName = "ReadClippingStats"
analysis_type = "ReadClippingStats"
...
@Argument(fullName="include_unmapped", shortName="u", doc="Include unmapped reads in the analysis", required=false, exclusiveOf="", validation="")
var include_unmapped: Boolean = _

/**
 * Short name of include_unmapped
 * @return Short name of include_unmapped
 */
def u = this.include_unmapped

/**
 * Short name of include_unmapped
 * @param value Short name of include_unmapped
 */
def u_=(value: Boolean) { this.include_unmapped = value }

/** Do not print all reads, skip some. */
@Argument(fullName="skip", shortName="skip", doc="Do not print all reads, skip some.", required=false, exclusiveOf="", validation="")
