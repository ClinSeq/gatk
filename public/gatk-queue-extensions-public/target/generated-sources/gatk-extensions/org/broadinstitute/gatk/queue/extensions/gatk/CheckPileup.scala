...
class CheckPileup extends org.broadinstitute.gatk.queue.extensions.gatk.CommandLineGATK with ScatterGatherableFunction {
analysisName = "CheckPileup"
analysis_type = "CheckPileup"
scatterClass = classOf[LocusScatterFunction]

/** Pileup generated by Samtools */
@Input(fullName="pileup", shortName="pileup", doc="Pileup generated by Samtools", required=true, exclusiveOf="", validation="")
var pileup: File = _

/** Dependencies on the index of pileup */
@Input(fullName="pileupIndex", shortName="", doc="Dependencies on the index of pileup", required=false, exclusiveOf="", validation="")
private var pileupIndex: Seq[File] = Nil
...
@Argument(fullName="continue_after_error", shortName="", doc="Continue after encountering an error", required=false, exclusiveOf="", validation="")
var continue_after_error: Boolean = _
